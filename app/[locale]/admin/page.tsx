...
interface JobsTabProps {
  ...
  onToggleJob: (id: string, currentActive: boolean) => void;
}
...
interface ProjectsTabProps {
  ...
  onToggleProject: (id: string, currentActive: boolean) => void;
}
              ...
              {projects.map((project) => (
                ...
                >
                  ...
                  <td className="py-3 px-4">
                    <button
                      onClick={() =>
                        onToggleProject(project.id, project.active)
                      }
                      className={`text-xs font-medium px-2 py-1 rounded cursor-pointer transition-colors ${
                        project.active
                          ? "bg-green-100 text-green-800 hover:bg-green-200"
