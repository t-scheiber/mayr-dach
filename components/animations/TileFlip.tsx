  ...
  return (
    ...
    >
      ...
      >
        ...
        {backContent && (
          <div className="absolute inset-0 w-full h-full backface-hidden transform-[rotateY(180deg)] bg-gray-900 rounded-xl text-white flex items-center justify-center p-4">
            {backContent}
          </div>
        )}
      </m.div>
